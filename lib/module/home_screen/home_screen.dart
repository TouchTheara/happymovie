...
import '../movies_page/controller/movies_controller.dart';

import '../tv_show/controller/tv_show_controller.dart';
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(height: 80, child: Container()
                        // ListView(
                        //   controller: ScrollController(),
                        //   // physics: const NeverScrollableScrollPhysics(),
                  ...
                  Padding(
                    ...
                    child: SizedBox(height: 45, child: Container()
                        // ListView(
                        //   scrollDirection: Axis.horizontal,
...
Widget buildMovie(MovieModel e, BuildContext context) => GestureDetector(
      onTap: () {
